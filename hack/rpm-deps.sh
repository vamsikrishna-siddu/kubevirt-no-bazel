...
# libraries need, like the //rpm:ldd_* Bazel targets do.
...
# Libraries whose dependencies bazeldnf_ldd collects. Keep in sync with the
# ldd_* rules in rpm/BUILD.bazel (CS10 adds libfido2).
libvirt_ldd_libs="
